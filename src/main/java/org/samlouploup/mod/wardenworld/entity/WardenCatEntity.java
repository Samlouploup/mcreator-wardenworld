...
public class WardenCatEntity extends Monster {
	public WardenCatEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WardenWorldModEntities.WARDEN_CAT.get(), world);
	}

	public WardenCatEntity(EntityType<WardenCatEntity> type, Level world) {
		super(type, world);
		maxUpStep = 3f;
		xpReward = 0;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(WardenWorldModEntities.WARDEN_CAT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
