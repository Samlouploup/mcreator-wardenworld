...
import org.samlouploup.mod.wardenworld.procedures.TheSculkLordQuandLentiteEstBlesseeProcedure;
...
public class TheSculkLordEntity extends Monster {
	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.BLUE, ServerBossEvent.BossBarOverlay.PROGRESS);

	public TheSculkLordEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WardenWorldModEntities.THE_SCULK_LORD.get(), world);
	}

	public TheSculkLordEntity(EntityType<TheSculkLordEntity> type, Level world) {
		super(type, world);
		maxUpStep = 4.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public boolean hurt(DamageSource source, float amount) {
		TheSculkLordQuandLentiteEstBlesseeProcedure.execute(source.getEntity());
