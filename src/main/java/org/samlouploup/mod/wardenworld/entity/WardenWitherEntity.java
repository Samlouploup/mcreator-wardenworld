...
import org.samlouploup.mod.wardenworld.procedures.WardenWitherEntityIsHurtProcedure;
...
public class WardenWitherEntity extends Monster implements RangedAttackMob {
	...
	public WardenWitherEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WardenWorldModEntities.WARDEN_WITHER.get(), world);
	}

	public WardenWitherEntity(EntityType<WardenWitherEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 4096;
		setNoAi(false);
	...
	public boolean hurt(DamageSource source, float amount) {
		WardenWitherEntityIsHurtProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		WardenWitherEntityProjectile entityarrow = new WardenWitherEntityProjectile(WardenWorldModEntities.WARDEN_WITHER_PROJECTILE.get(), this, this.level);
