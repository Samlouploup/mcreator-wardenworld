...
package org.samlouploup.mod.wardenworld.world.features;
...
public class LordTempleFeature extends Feature<NoneFeatureConfiguration> {
	public static LordTempleFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new LordTempleFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("warden_world:lord_temple", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("warden_world:lord_temple", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("warden_world", "lord_temple"));
		if (template == null)
			return false;
