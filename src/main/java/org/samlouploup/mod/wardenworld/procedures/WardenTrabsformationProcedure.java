...
public class WardenTrabsformationProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		if (entity.getType().is(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, new ResourceLocation("forge:warden_entity")))) {
			if (sourceentity instanceof ServerPlayer _player) {
				Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("warden_world:killsculk_mobs"));
			...
			if (entity instanceof LivingEntity _livEnt ? _livEnt.hasEffect(WardenWorldModMobEffects.WARDEN_FEVER.get()) : false) {
				if (world instanceof ServerLevel _level) {
					Entity entityToSpawn = new LittleWardenEntity(WardenWorldModEntities.LITTLE_WARDEN.get(), _level);
